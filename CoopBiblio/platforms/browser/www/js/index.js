...
{ ;
    db.scan({
        ...
        setTimeout(function(){trieEmprunt(items)},1000);
    });
}
...
function trieEmprunt(emprunt)
{
    ...
    emprunts = emprunt;
    doc=document.getElementById("a").value;
   ...
   emprunt.sort(function(a,b) {return (a.dateRendu > b.dateRendu) ? 1 : ((b.dateRendu > a.dateRendu) ? -1 : 0);});
    ...
    {    
        ...
        Texe=(titreLivre+ " "+nom+" "+prenom+" "+dateRendu).toUpperCase();
        text1=Texe.toUpperCase();
